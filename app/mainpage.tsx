...
//       <header className="px-4 lg:px-6 h-14 flex items-center fixed w-full bg-white/80 backdrop-blur-sm z-10">
...
//           <Image
//             src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202024-08-19%20at%207.39.01%20PM-uwQGFNdyzAPgIRqq7gkwrvepYztIqa.jpeg"
//             alt="Background"
//             layout="fill"
//             objectFit="cover"
...
//                   <Button variant="outline" size="lg" className="bg-white text-purple-500 hover:bg-purple-100">
//                     View Experience
//                   </Button>
//                 </Link>
//               </motion.div>
